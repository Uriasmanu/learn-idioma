...
export default function Cartao({ showInfo, title, traducao, handleButtonClick }: CartaoProps) {
    return (
        <div className="relative flex flex-col h-[28rem] w-[19rem] border-2 border-black bg-white rounded-2xl overflow-hidden">
            ...
            <div className={`absolute top-0 left-0 right-0 bottom-0 flex flex-col p-6 transition-opacity duration-300 ${showInfo ? 'opacity-100' : 'opacity-0'}`}>
                <div className="flex flex-col items-center justify-center h-full">
