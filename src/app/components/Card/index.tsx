...
export default function Card() {
    return (
        ...
        <div
            className="relative flex h-[20rem] w-60 transform items-end border-2 border-black bg-white transition-transform group-hover:scale-105 rounded-2xl"
        >
            <div
            ...
            >
                ...
                <h2 className="mt-4 text-xl font-medium sm:text-2xl">Sushma Godawari</h2>
            </div>

            <div
                className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
            >
                <h3 className="mt-4 text-xl font-medium sm:text-2xl">Sushma Godawari</h3>
